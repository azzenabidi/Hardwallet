 ...
 *
 */
class ConstructorsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'website' => ['type' => 'string', 'length' => 120, 'null' => true, 'default' => 'not provided', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-07-25 04:21:52',
            'modified' => '2016-07-25 04:21:52'
        ],
    ];
}
