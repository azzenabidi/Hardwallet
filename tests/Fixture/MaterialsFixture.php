...
class MaterialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'serial_number' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'constructor_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'category_id' => 1,
            'constructor_id' => 1,
            'created' => '2016-07-25 22:19:22',
            'modified' => '2016-07-25 22:19:22'
        ],
    ];
}
